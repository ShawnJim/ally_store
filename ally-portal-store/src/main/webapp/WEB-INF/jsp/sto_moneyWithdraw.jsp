				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu active"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li class="active"><a id="jump_for_page013" class="" href="${STO_ADRESS}/sto_moneyWithdraw.html">提现</a></li>
		...
		<div class="pay">
			...
			<div class="tr_recharge">
				<div class="tr_rechtext">
					<p class="te_retit"><img src="${APP_PATH}/static/images/coin.png" alt="" />提现中心</p>
<!-- 					<p>1.招兵币是51招兵买马退出的虚拟货币，你可以使用招兵币购买站内的简历。</p>
				...
				<form class="am-form" id="doc-vld-msg">
					<div class="tr_rechbox">
						...
						<div class="tr_rechnum">
							<span>应付金额：</span>
							<p class="rechnum" id="withdrawMoney">0.00元</p>
						</div>
					</div>
					<div class="tr_paybox">
						<input type="button" value="确认提现" class="tr_pay am-btn" id="subWithdrawMoney"/>
	...
	<script>
		...
		//点击提现按钮
		$("#subWithdrawMoney").click(function(){
			var id = getUrlParam("Id");
			var moneys = $("#withdrawMoney").text();//获得充值金额
			var indexOf = moneys.length;//计算长度
			var money = moneys.substring(0,indexOf-1);//截取需要的金额
			alert(money);
				$.ajax({
					url : "${IP_ADRESS}/rest/withdrawMoney?id="+id+"&money="+money,
					type : "POST",
					success : function(result) {
						if (result.code == 100) {
							console.log(result);
