...
<link rel="stylesheet" type="text/css"
	href="${APP_PATH}/static/css/amazeui.min.css" />
<link rel="stylesheet" type="text/css"
	href="${APP_PATH}/static/css/main.css" />
...
<body>
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu active"><a href="javascript:;" class="">
							<i class="icon-cogs"></i> <span>订单管理</span> <span class="arrow"></span>
					</a>
						<ul class="sub">
							<li class="active"><a id="jump_for_page06" class=""
								href="${STO_ADRESS }/sto_allOrder.html">全部订单</a></li>
							<li><a id="jump_for_page07" class=""
								href="${STO_ADRESS }/sto_waitCompleteOrder.html">待完成订单</a></li>
							<li><a id="jump_for_page08" class=""
								href="${STO_ADRESS }/sto_waitpayforOrder.html">未付款订单</a></li>
							<li><a id="jump_for_page05" class=""
								href="${STO_ADRESS }/sto_CompleteOrder.html">已完成订单</a></li>
						</ul></li>
	...
	<script>
		...
		function toPage(pn) {
			$.ajax({
				url : "${IP_ADRESS}/rest/get_orderByStoid",
				data : {
					pn : pn,
					stoid : $("#user_id_val").val()
				},
				type : "GET",
				success : function(result) {
					console.log(result);
