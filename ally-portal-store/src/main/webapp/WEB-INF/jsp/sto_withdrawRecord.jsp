...
<body>
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu active"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li class="active"><a id="jump_for_page015" class="" href="${STO_ADRESS}/sto_withdrawRecord.html">提现记录</a></li>
						</ul></li>
					<li class="sub-menu"><a class="" href="javascript:;"> <i
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="form_sele_pro">
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">提现订单号</label>
										<div class="col-sm-2">
	...
	<script>
		...
		function toPage(pn) {
			$.ajax({
				url : "${IP_ADRESS}/rest/withDrawrechargeRecord",
				data : {
					pn : pn,
		...
		function from_get_pros(){
			...
			$.ajax({
				url : "${IP_ADRESS}/rest/select_withdrawRecordByNumber",
				data : {
					pn : 1,
					number : number
				},
