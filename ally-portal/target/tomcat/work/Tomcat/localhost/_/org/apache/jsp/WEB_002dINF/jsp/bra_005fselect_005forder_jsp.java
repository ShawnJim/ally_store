 ...
 * Generated at: 2018-06-26 03:24:55 UTC
...
public final class bra_005fselect_005forder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	pageContext.setAttribute("IP_ADRESS", "http://localhost:8081");
      ...
      out.write("\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${IP_ADRESS}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/rest/get_orderByBraid\",\r\n");
      out.write("\t\t\t\tdata : {\r\n");
      out.write("\t\t\t\t\tpn : pn,\r\n");
      out.write("\t\t\t\t\tbraid : $(\"#user_id_val\").val()\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\ttype : \"GET\",\r\n");
      out.write("\t\t\t\tsuccess : function(result) {\r\n");
      out.write("\t\t\t\t\tconsole.log(result);\r\n");
      ...
      out.write("\t\t\tconsole.log(result);\r\n");
      out.write("\t\t\t//每次清空员工信息\r\n");
      out.write("\t\t\tif(pros[0].orderuuid!=\"\"||pros[0].orderuuid!=null){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//成功按钮\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar sucsTd = $(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\"<button type='button'></button>\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.addClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\"btn btn-success btn-sm sucs_btn\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"<span></span>\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.addClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\"glyphicon glyphicon-saved\"))\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.append(\"完成\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsucsTd.attr(\"sucs_id\", item.orderuuid);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//添加到按钮组件\r\n");
      out.write("\t\t\t\t\t\t\t\t\tbutton.append(paybtnTd).append(\" \").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\trepealbtnTd).append(\" \").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tdelTd).append(\" \").append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tsucsTd);\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//结束订单\r\n");
      out.write("\t\t$(document).on(\"click\", \".sucs_btn\", function() {\r\n");
      out.write("\t\t\tvar proName = $(this).parents(\"tr\").find(\"td:eq(1)\").text();\r\n");
      out.write("\t\t\tvar proIds = $(this).attr(\"sucs_id\");\r\n");
      out.write("\t\t\tif (confirm(\"确定通过【\" + proName + \"】吗\")) {\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${IP_ADRESS}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/rest/update_order\",\r\n");
